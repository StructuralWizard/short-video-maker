...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var config, localTTS, text, outputPath, emotion, language, referenceAudioPath, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    config = new config_1.Config();
                    return [4 /*yield*/, LocalTTS_1.LocalTTS.init(config)];
                case 1:
                    localTTS = _a.sent();
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, localTTS.generateSpeech(text, outputPath, emotion, language, referenceAudioPath)];
                case 3:
                    _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error("❌ Erro ao gerar áudio:", error_1);
                    return [3 /*break*/, 5];
